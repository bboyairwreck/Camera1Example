...
/**
 * Created by echee on 5/2/17.
 *
 * Reference http://stackoverflow.com/questions/19577299/android-camera-preview-stretched
 */

public class WaveCameraManager extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public WaveCameraManager(Context context, Camera camera) {
        super(context);
        mContext = context;
        mCamera = camera;
